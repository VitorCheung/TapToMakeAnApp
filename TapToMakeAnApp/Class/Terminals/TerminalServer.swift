...
public class TerminalServer: SKSpriteNode{
    ...
    func addApp(x:CGFloat, y:CGFloat, indexApp: Int){
        ...
        labelApp.text = NSLocalizedString("Sell", comment: "")+": \(Int64.numRedable(num: app.money))$"
        ...
        labelInfo.text = NSLocalizedString("points", comment: "")+": \(Int64.numRedable(num: Int64(app.points)))\n"+NSLocalizedString("Earning", comment: "")+": \(Int64.numRedable(num: app.earning))$"
